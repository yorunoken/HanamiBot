...
async function getRecentPlays({ user, plays, mode, index, isTops, locale }: { user: UserInfo, plays: Array<ScoreResponse>, mode: osuModes, index: number, isTops: boolean, locale: Locales }) {
...
async function getSubsequentPlays({ user, plays, mode, page, index, isTops, locale }: { user: UserInfo, plays: Array<ScoreResponse>, mode: osuModes, page: number | undefined, index: number, isTops: boolean, locale: Locales }) {
    if (index >= 0) {
