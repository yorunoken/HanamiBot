...
exports.run = async (client, message, args, prefix, EmbedBuilder) => {
    ...
    .setDescription(`You may invite me to your server using [this link](https://discord.com/api/oauth2/authorize?client_id=995999045157916763&permissions=1099646134598&scope=bot)`)
