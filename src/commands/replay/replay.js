			...
			const Replay = async () => {
				...
				try {
					replay = await ordrclient.newRender({
						...
						useSkinColors: userData[message.author.id].skin_colors,
						playNightcoreSamples: userData[message.author.id].nightcore_hs,
						skip: userData[message.author.id].skip_intro,
