...
async function run(interaction: Interaction<ApplicationCommandData>): Promise<void> {
    ...
    const embeds = await playBuilder({ user: osuUser, mode: user.mode, initiatorId: interaction.member.user.id, type: "best", page, index, mods, isMultiple: true, sortByDate: true });
