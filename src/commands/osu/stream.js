...
exports.run = async (client, message, args, prefix) => {
	...
	if (argValues["longest"]) {
		longest_min = {
			...
			operator: "minimum",
			value: Number(argValues["longest"]) - 5,
		}
		longest_max = {
			property: "longest_stream",
			operator: "maximum",
	...
	if (argValues["streamlength"]) {
		streamlength_min = {
			...
			operator: "minimum",
			value: Number(argValues["streamlength"]) - 4,
		}
		streamlength_max = {
			property: "streams_length",
			operator: "maximum",
