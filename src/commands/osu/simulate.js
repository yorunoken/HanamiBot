...
const {
  BeatmapCalculator,
  ScoreCalculator,
} = require("@kionell/osu-pp-calculator");
  ...
  async function SendEmbed(beatmapId) {
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setFields({
          name: `**Beatmap info:**`, value: `Stars: \`${pp.difficulty.starRating.toFixed(2)}★\` BPM: \`${pp.scoreInfo.beatmap.bpmMode.toFixed()}\` Length: \`${minutes}:${seconds
