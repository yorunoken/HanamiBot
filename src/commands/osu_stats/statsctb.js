...
exports.name = ["statsctb"]
exports.aliases = ["statsctb", "statctb", "statsc", "statc", "ctbstats", "ctbstat"]
exports.description = ["Displays user's osu!ctb stats\n\n**Parameters:**\n`username`"]
exports.usage = [`statsctb YoruNoKen`]
