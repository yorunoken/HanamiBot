...
// importing GetRecent
const { GetUserTop100Stats } = require("../../exports/stats_export.js")
...
exports.name = ["statsmania"]
exports.aliases = ["statsmania", "statmania", "statsm", "statm", "mstats", "mstat", "maniastats"]
exports.description = ["Displays user's osu!mania stats\n\n**Parameters:**\n`username`"]
exports.usage = [`statsm YoruNoKen`]
